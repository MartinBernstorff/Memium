...
from personal_mnemonic_medium.destinations.anki_prompt_base import (
    AnkiCard,
)
from personal_mnemonic_medium.destinations.anki_prompt_cloze import (
    AnkiCloze,
)
from personal_mnemonic_medium.destinations.anki_prompt_qa import (
    AnkiQA,
)

from ..source.prompt_base import BasePrompt
from ..source.prompt_cloze import ClozePrompt
from ..source.prompt_qa import QAPrompt
